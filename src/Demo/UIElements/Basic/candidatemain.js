...
const BasicButton = () =>  {
    ...
    async function getdatacandidateall() {
        const res = await fetch('http://13.250.116.42/node/express/api/candidate/getcandidate/',{
            method: 'GET',
            headers: {
    ...
    async function getdatacurrent() {
        const res = await fetch('http://13.250.116.42/node/express/api/candidate/getcandidate/summary/current/',{
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'authorization': ID_Token
    ...
    async function getdatainterview1() {
        const res = await fetch('http://13.250.116.42/node/express/api/candidate/getcandidate/summary/interview1/',{
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'authorization': ID_Token
    ...
    async function getdatainterview2() {
        const res = await fetch('http://13.250.116.42/node/express/api/candidate/getcandidate/summary/interview2/',{
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'authorization': ID_Token
    ...
    async function getdatapass() {
        const res = await fetch('http://13.250.116.42/node/express/api/candidate/getcandidate/summary/pass/',{
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'authorization': ID_Token
