...
const Deptview = () =>  {
    ...
    async function getdatauser() {
        const res = await fetch('http://13.250.116.42/node/express/api/profile/getprofile/dept/position/'+Dept+'/'+Position,{
            method: 'GET',
            headers: {
    ...
    async function getdatasummaryuser() {
        const res = await fetch('http://13.250.116.42/node/express/api/department/getdept/manpower/dept/summary/' + Position,{
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'authorization': ID_Token
